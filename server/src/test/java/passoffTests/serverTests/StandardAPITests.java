...
public class StandardAPITests {
    ...
    public void goodCreate() throws TestException {
        ...
        Assertions.assertFalse(
                createResult.message != null && createResult.message.toLowerCase(Locale.ROOT).contains("error"),
                "Result returned an error message");
        Assertions.assertNotNull(createResult.gameID, "Result did not return a chessGame ID");
        Assertions.assertTrue(createResult.gameID > 0, "Result returned invalid chessGame ID");
    }
    ...
    public void badAuthCreate() throws TestException {
        ...
        Assertions.assertNull(createResult.gameID, "Bad result returned a chessGame ID");
    }
    ...
    public void goodWatch() throws TestException {
        ...
        Assertions.assertNull(listResult.games[0].whiteUsername, "Player present on a chessGame that no player joined");
        Assertions.assertNull(listResult.games[0].blackUsername, "Player present on a chessGame that no player joined");
    }
    ...
    public void clearData() throws TestException {
        ...
        createRequest.gameName = "Awesome chessGame";
        serverFacade.createGame(createRequest, existingAuth);
        ...
        //create and join chessGame for new user
